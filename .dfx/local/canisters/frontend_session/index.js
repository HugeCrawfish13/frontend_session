...
import { idlFactory } from './frontend_session.did.js';
export { idlFactory } from './frontend_session.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FRONTEND_SESSION;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./frontend_session.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the frontend_session canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./frontend_session.did.js")._SERVICE>}
 */
export const frontend_session = createActor(canisterId);
